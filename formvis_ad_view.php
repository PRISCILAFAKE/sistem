...
try {
    ...
    $numeroOrden = str_pad($cantidad_requerimientos, 3, '0', STR_PAD_LEFT);
...
<head>
    ...
    <title>Vista de Requerimiento - Admin</title>
...
<div class="container mt-4 mb-4" style="max-width: 800px;">
    <div class="card shadow-sm p-4 border-0">
        ...
        <div class="border-bottom pb-3 mb-4">
            <div class="row align-items-center">
                <div class="col-8">
                    ...
                    <p class="text-muted small m-0">Panel de Gestión de Requerimientos</p>
                </div>
        ...
        <div class="d-flex justify-content-end gap-2 no-print">
            <a href="solicitud_crud_view.php" class="btn btn-secondary btn-sm"><i class="bi bi-arrow-left"></i> Volver al Panel </a>
        </div>
    </div>
</div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (urlParams.get('imprimir') === 'true') {
            ...
            window.addEventListener('focus', function() {
                setTimeout(function() { window.location.href = 'solicitud_crud_view.php'; }, 300);
            }, { once: true });
        }
    });
</script>
