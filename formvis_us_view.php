...
<head>
    ...
    <title>Solicitud de Cambios / Nuevos Módulos</title>
        ...
        <div class="border-bottom pb-3 mb-4">
            <div class="row align-items-center">
                <div class="col-8">
                    ...
                    <p class="text-muted small m-0">Sistema de Gestión de Mis Requerimientos</p>
                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (urlParams.get('imprimir') === 'true') {
            ...
            window.addEventListener('focus', function() {
                setTimeout(function() { window.location.href = '../View/solicitud_view.php'; }, 300);
            }, { once: true });
        }
    });
</script>
